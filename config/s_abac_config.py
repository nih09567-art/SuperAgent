...
AGENT_SECURITY_ATTRIBUTES = {
    ...
    "RemoteWeatherAgent": {
        "role": "ResearchAgent",
        "department": "Research",
        "job_role": "weather_service_agent",
        "clearance_level": 1,
        "trust_level": "MEDIUM",
        "grants": ["weather_read"],
    },
    "RemoteScheduleAgent": {
        "role": "OperationAgent",
        "department": "Office",
        "job_role": "schedule_operations_agent",
        "clearance_level": 2,
        "trust_level": "HIGH",
        "grants": ["schedule_write"],
    },
    "RemoteTodoAgent": {
        "role": "OperationAgent",
        "department": "Office",
        "job_role": "todo_service_agent",
        "clearance_level": 2,
        "trust_level": "MEDIUM",
        "grants": ["todo_read"],
    },
    "RemoteHRCalendarAgent": {
        "role": "HRAgent",
        "department": "HR",
        "job_role": "hr_calendar_agent",
        "clearance_level": 3,
        "trust_level": "HIGH",
        "grants": ["calendar_read", "calendar_write"],
    },
}
...
RESOURCE_SECURITY_ATTRIBUTES = {
    ...
    "RemoteWeatherAgent": {
        "type": "agent",
        "department_domain": "Research",
        "capability_domain": "Weather",
        "sensitivity": "LOW",
        "allowed_roles": ["UniversalAssistant", "ResearchAgent", "OperationAgent"],
        "allowed_job_roles": ["research_analyst", "office_operator", "system_orchestrator"],
        "allowed_operation_modes": ["delegate", "query", "read"],
        "scenario_tags": ["weather_query", "travel_service"],
        "expected_capabilities": ["Weather", "Research"],
    },
    "RemoteScheduleAgent": {
        "type": "agent",
        "department_domain": "Office",
        "capability_domain": "Office",
        "sensitivity": "MEDIUM",
        "allowed_roles": ["UniversalAssistant", "OperationAgent"],
        "allowed_job_roles": ["office_operator", "office_manager", "system_orchestrator"],
        "allowed_operation_modes": ["delegate", "write"],
        "scenario_tags": ["schedule_management", "office_operation"],
        "expected_capabilities": ["Office", "Operations"],
    },
    "RemoteTodoAgent": {
        "type": "agent",
        "department_domain": "Office",
        ...
        "allowed_job_roles": ["office_operator", "office_manager", "system_orchestrator"],
        "allowed_operation_modes": ["delegate", "query", "read"],
        "scenario_tags": ["schedule_management", "todo_management"],
        "expected_capabilities": ["Office", "Operations"],
    },
    "RemoteHRCalendarAgent": {
        "type": "agent",
    ...
    "query_travel_record": {
        ...
        "allowed_job_roles": ["office_operator", "office_manager", "hr_manager", "system_orchestrator"],
        "allowed_operation_modes": ["query", "read"],
        "scenario_tags": ["travel_service"],
        "expected_capabilities": ["Travel", "Office", "Operations"],
    },
    "remote_weather_tool": {
        "owner_agent": "RemoteWeatherAgent",
        "capability_domain": "Weather",
        "department_domain": "Public",
        "sensitivity": "LOW",
        "allowed_roles": ["UniversalAssistant", "ResearchAgent"],
        "allowed_job_roles": [],
        "allowed_operation_modes": ["query", "read"],
        "scenario_tags": ["weather_query"],
        "expected_capabilities": ["Weather", "Research"],
    },
    "remote_unicorn_db_tool": {
        "owner_agent": "RemoteUnicornSelectorAgent",
        "capability_domain": "Research",
        "department_domain": "Research",
        "sensitivity": "MEDIUM",
        "allowed_roles": ["ResearchAgent", "UniversalAssistant"],
        "allowed_job_roles": ["research_analyst", "business_analyst", "system_orchestrator"],
        "allowed_operation_modes": ["query", "read"],
        "scenario_tags": ["market_research", "information_research"],
        "expected_capabilities": ["Research"],
    },
    "remote_credit_risk_db_tool": {
        "owner_agent": "RemoteBusinessRiskAgent",
        "capability_domain": "Risk",
        "department_domain": "Risk",
        "sensitivity": "HIGH",
        "allowed_roles": ["RiskAgent", "UniversalAssistant"],
        "allowed_job_roles": ["risk_analyst", "risk_manager", "system_orchestrator"],
        "allowed_operation_modes": ["query", "read"],
        "scenario_tags": ["risk_analysis"],
        "expected_capabilities": ["Risk"],
    },
    "remote_report_builder_tool": {
        "owner_agent": "RemoteReportAgent",
        "capability_domain": "Document",
        "department_domain": "Office",
        "sensitivity": "MEDIUM",
        "allowed_roles": ["ReportAgent", "UniversalAssistant"],
        "allowed_job_roles": ["report_specialist", "business_analyst", "risk_analyst", "system_orchestrator"],
        "allowed_operation_modes": ["generate"],
        "scenario_tags": ["reporting", "analysis_summary"],
        "expected_capabilities": ["Document"],
    },
    "remote_contact_query_tool": {
        "owner_agent": "RemoteCommunicationAgent",
        "capability_domain": "Communication",
        "department_domain": "Office",
        "sensitivity": "MEDIUM",
        "allowed_roles": ["CommunicationAgent", "UniversalAssistant"],
        "allowed_job_roles": ["communication_officer", "communication_manager", "system_orchestrator"],
        "allowed_operation_modes": ["query", "read", "send"],
        "scenario_tags": ["notification_send", "contact_lookup"],
        "expected_capabilities": ["Communication"],
    },
    "remote_schedule_tool": {
        "owner_agent": "RemoteScheduleAgent",
        "capability_domain": "Office",
        "department_domain": "Office",
        "sensitivity": "MEDIUM",
        "allowed_roles": ["OperationAgent", "UniversalAssistant"],
        "allowed_job_roles": ["office_operator", "office_manager", "system_orchestrator"],
        "allowed_operation_modes": ["query", "read", "write", "update"],
        "scenario_tags": ["office_assistance"],
        "expected_capabilities": ["Office", "Operations"],
    },
    "remote_todo_query_tool": {
        "owner_agent": "RemoteTodoAgent",
        "capability_domain": "Office",
        "department_domain": "Office",
        "sensitivity": "MEDIUM",
        "allowed_roles": ["OperationAgent", "UniversalAssistant"],
    ...
    "get_calendar_events_tool": {
        "owner_agent": "RemoteHRCalendarAgent",
        "capability_domain": "Office",
        "department_domain": "Office",
        "sensitivity": "HIGH",
        "allowed_roles": ["OperationAgent", "HRAgent", "UniversalAssistant"],
        "allowed_job_roles": ["office_operator", "office_manager", "hr_manager", "system_orchestrator"],
        "allowed_operation_modes": ["query", "read"],
        "scenario_tags": ["office_assistance", "meeting_management"],
        "expected_capabilities": ["HR", "Office"],
    },
    ...
    "remote_meeting_scheduling_tool": {
        "owner_agent": "RemoteMeetingManagerAgent",
        "capability_domain": "Meeting",
        "department_domain": "Office",
        "sensitivity": "HIGH",
        "allowed_roles": ["OperationAgent", "CommunicationAgent", "UniversalAssistant"],
        "allowed_job_roles": ["office_operator", "office_manager", "communication_officer", "hr_manager", "system_orchestrator"],
        "allowed_operation_modes": ["write", "update"],
